...
Data_ini = data_inf[['var-1_lag','var-3_lag','var-6_lag','var-12_lag']][1:101]


    

def shap_plot(ind,X,model_xg):
...
def home():
    ...
    data_drift_report.calculate(Data_ini,X, column_mapping = None)
